...
/**
 * Test for /profiles/{guid}
 */
Test('/profiles/{guid}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test profiles_get get operation', function (t) {
            Mockgen().requests({
                path: '/profiles/{guid}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/profiles/{guid}']['get']['responses']['200']['schema']);
